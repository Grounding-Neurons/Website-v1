        ...
        <main className='bg-white'>
            ...
            <div id='triggerElement' className='pt-20 flex relative justify-center items-center h-[35vh]'>
                ...
                <div className='absolute z-1'>
                    <p className='font-librecaslontext text-white text-3xl max-w-72 sm:max-w-none sm:text-4xl slide-animation-short text-center'>
            ...
            <div id='webmaster' className='flex flex-col sm:py-8 justify-center items-center'>
                ...
                <div className='pt-10 sm:pt-16 text-center max-w-[1080px]'>
                    <p className='sm:px-6 font-librecaslontext text-gray-600 text-base max-w-xs sm:max-w-none sm:text-xl'>For any questions, concerns, or reports about the Grounding Neurons website, including any potential vulnerabilites or broken content, please contact the Webmaster at the email below:</p>
                    <div className='pt-12'>
